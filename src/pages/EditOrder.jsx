        ...
        <div className="flex items-center space-x-4 space-x-reverse">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              נוצר:{" "}
              {format(parseISO(order.created_date), "dd/MM/yyyy HH:mm", {
                locale: he,
              })}
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        <Card className="lg:col-span-2">
          ...
          <CardContent className="space-y-4">
              ...
              <div>
                ...
                {isEditMode ? (
                  ...
                  <p className="mt-1 text-sm">
                    {order.order_number_permanent || "לא הוזן"}
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="purchase_order_number_sap">
                  מספר דרישת רכש SAP
                </Label>
                {isEditMode ? (
                  <Input
                  ...
                  <p className="mt-1 text-sm">
                    {order.purchase_order_number_sap || "לא הוזן"}
                  </p>
                )}
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label htmlFor="expected_delivery_start_date">
                  תאריך אספקה צפוי (התחלה)
                </Label>
                {isEditMode ? (
                  <Input
                  ...
                  <p className="mt-1 text-sm">
                    {order.expected_delivery_start_date
                      ? format(
                          parseISO(order.expected_delivery_start_date),
                          "dd/MM/yyyy",
                          { locale: he },
                        )
                      : "לא צוין"}
              ...
              <div>
                <Label htmlFor="expected_delivery_end_date">
                  תאריך אספקה צפוי (סיום)
                </Label>
                {isEditMode ? (
                  <Input
                  ...
                  <p className="mt-1 text-sm">
                    {order.expected_delivery_end_date
                      ? format(
                          parseISO(order.expected_delivery_end_date),
                          "dd/MM/yyyy",
                          { locale: he },
                        )
                      : "לא צוין"}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              order.linked_withdrawal_request_ids.length > 0 ? (
                <div className="mt-2 space-y-2">
                  {order.linked_withdrawal_request_ids.map(
                    (withdrawalId, idx) => (
                      <Link
                        key={withdrawalId}
                        to={createPageUrl(
            ...
            <div>
              ...
              {order.linked_delivery_ids &&
              order.linked_delivery_ids.length > 0 ? (
                <div className="mt-2 space-y-2">
            ...
            {[
              ...
              <Link
                to={createPageUrl(`NewDelivery?order_id=${order.id}`)}
